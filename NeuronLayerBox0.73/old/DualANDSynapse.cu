...
__global__ static void Dual_AND_Synapse(struct synapse *syn, struct axon *neuro,unsigned char *spike,int *Ix,int *THREAD_SYN,int *BLOCK_SYN)
{
...
//  if(I_AMPA<0){I_AMPA=0.000001;}
  ...
  atomicAdd(&Ix[syn[number].postsynapse_number],int(I_AMPA+I_NMDA)); //  Ix[syn[number].postsynapse_number]+=I_AMPA+I_NMDA;  //ԭ�Ӳ���
...
{
	f=(timeN-1)*0.004-0.5;       //f=(timeN-1)*0.2*0.02-0.5;
}
else
{
  f=0;
}
w=w+tau*gsyn*v*v*(gsyn*f*(-2)+1-w);
//  if(w<0.5){printf("%f\n",w); }
...
//  if(I_AMPA<0){I_AMPA=0.000001;}
  ...
  atomicAdd(&Ix[syn[number+1].postsynapse_number],int(I_AMPA+I_NMDA)); //  Ix[syn[number].postsynapse_number]+=I_AMPA+I_NMDA;  //ԭ�Ӳ���
...
//  if(I_AMPA<0){I_AMPA=0.000001;}
  ...
  atomicAdd(&Ix[syn[number+2].postsynapse_number],int(I_AMPA+I_NMDA)); //  Ix[syn[number].postsynapse_number]+=I_AMPA+I_NMDA;  //ԭ�Ӳ���
...
//  if(I_AMPA<0){I_AMPA=0.000001;}
  ...
  atomicAdd(&Ix[syn[number+3].postsynapse_number],int(I_AMPA+I_NMDA)); //  Ix[syn[number].postsynapse_number]+=I_AMPA+I_NMDA;  //ԭ�Ӳ���
...
//  if(I_AMPA<0){I_AMPA=0.000001;}
  ...
  atomicAdd(&Ix[syn[number+4].postsynapse_number],int(I_AMPA+I_NMDA)); //  Ix[syn[number].postsynapse_number]+=I_AMPA+I_NMDA;  //ԭ�Ӳ���
...
//  if(I_AMPA<0){I_AMPA=0.000001;}
  ...
  atomicAdd(&Ix[syn[number+5].postsynapse_number],int(I_AMPA+I_NMDA)); //  Ix[syn[number].postsynapse_number]+=I_AMPA+I_NMDA;  //ԭ�Ӳ���
...
//  if(I_AMPA<0){I_AMPA=0.000001;}
  ...
  atomicAdd(&Ix[syn[number+6].postsynapse_number],int(I_AMPA+I_NMDA)); //  Ix[syn[number].postsynapse_number]+=I_AMPA+I_NMDA;  //ԭ�Ӳ���
...
//  if(I_AMPA<0){I_AMPA=0.000001;}
  ...
  atomicAdd(&Ix[syn[number+7].postsynapse_number],int(I_AMPA+I_NMDA)); //  Ix[syn[number].postsynapse_number]+=I_AMPA+I_NMDA;  //ԭ�Ӳ���
...
//  if(I_AMPA<0){I_AMPA=0.000001;}
  ...
  atomicAdd(&Ix[syn[number+8].postsynapse_number],int(I_AMPA+I_NMDA)); //  Ix[syn[number].postsynapse_number]+=I_AMPA+I_NMDA;  //ԭ�Ӳ���
...
//  if(I_AMPA<0){I_AMPA=0.000001;}
  ...
  atomicAdd(&Ix[syn[number+9].postsynapse_number],int(I_AMPA+I_NMDA)); //  Ix[syn[number].postsynapse_number]+=I_AMPA+I_NMDA;  //ԭ�Ӳ���
